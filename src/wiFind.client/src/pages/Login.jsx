...
function Login() {
    ...
    return (
        ...
        <div style={{ background: "#fff", borderRadius: "8px", boxShadow: "0 0 10px rgba(0, 0, 0, 0.1)", padding: "30px", maxWidth: "350px", width: "100%", boxSizing: "border-box", marginTop: "-150px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                    <input 
                        ...
                        style={{ width: "100%", height: "40px", marginBottom: "20px", border: "1px solid lightgrey", borderRadius: "4px", padding: "10px", boxSizing: "border-box", fontSize: "16px",  marginLeft: "10px" }} 
                    />
                    <input 
                        type="password" 

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SupportTickets_Users_assigned_to",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    curr_rate = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    time_listed = table.Column<DateTime>(type: "datetime2", nullable: false),
                    owned_by = table.Column<string>(type: "nvarchar(50)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Wifis_AccountInfos_owned_by",
                        column: x => x.owned_by,
                        principalTable: "AccountInfos",
                        principalColumn: "username",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "user_id", "amt_made", "dob", "first_name", "last_name", "phone_number" },
                values: new object[,]
                {
                    { "06ed4db9-5799-4f39-85ba-3ac9c7f28729", 0.00m, new DateOnly(1, 1, 1), "admin1", "ticketuser", "222-222-2222" },
                    { "15ced7de-6cde-4d80-abc7-fb5d86179912", 0.00m, new DateOnly(1, 1, 1), "user1", "tester", "111-1111-1111" },
                    { "1c96d917-98fc-402e-855e-5ddf1e5276b6", 0.00m, new DateOnly(1, 1, 1), "user7", "tester", "777-777-7777" },
                    { "2a4aebdc-1a4f-47ee-b415-e4a6797f4231", 0.00m, new DateOnly(1, 1, 1), "user8", "tester", "888-888-8888" },
                    { "c1c35566-4fd3-4839-aa94-d8c85ccd4943", 0.00m, new DateOnly(1, 1, 1), "user3", "tester", "333-333-3333" },
                    { "cc7c133a-b731-4299-b310-770ba9f3fe9f", 0.00m, new DateOnly(1, 1, 1), "user9", "tester", "999-999-9999" },
                    { "ea2cef69-f132-402a-a162-e7d774388a64", 0.00m, new DateOnly(1, 1, 1), "user5", "tester", "555-555-5555" },
                    { "f4140a29-60b3-4e84-a8d6-0274432509a5", 0.00m, new DateOnly(1, 1, 1), "user10", "tester", "000-000-0000" },
                    { "f57d0e07-917a-47ea-86fc-eeee80ae5f13", 0.00m, new DateOnly(1, 1, 1), "user6", "tester", "666-666-6666" },
                    { "f69b8103-bf31-4cf0-a624-4f848de8a2eb", 0.00m, new DateOnly(1, 1, 1), "user4", "tester", "444-444-4444" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "user6", "user6@example.com", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new byte[] { 116, 203, 119, 59, 69, 123, 72, 253, 73, 164, 150, 72, 208, 176, 210, 0, 254, 154, 88, 40, 79, 227, 151, 35, 252, 24, 252, 90, 66, 179, 50, 54, 84, 85, 215, 20, 170, 154, 155, 95, 111, 90, 0, 140, 224, 72, 116, 110, 2, 108, 12, 70, 177, 56, 246, 144, 112, 10, 228, 180, 61, 135, 235, 47 }, new byte[] { 132, 198, 229, 224, 40, 212, 246, 28, 246, 15, 50, 8, 31, 62, 248, 123, 253, 89, 212, 4, 135, 21, 85, 208, 1, 252, 38, 14, 137, 39, 222, 252, 53, 136, 174, 123, 26, 27, 125, 187, 14, 171, 233, 106, 170, 196, 184, 89, 149, 178, 55, 26, 85, 88, 54, 125, 26, 15, 138, 57, 103, 147, 29, 20, 228, 222, 155, 17, 171, 163, 83, 181, 14, 23, 134, 76, 253, 2, 208, 208, 141, 40, 47, 190, 163, 65, 7, 105, 192, 213, 137, 26, 44, 127, 196, 2, 63, 175, 52, 73, 224, 102, 3, 89, 87, 109, 248, 77, 166, 105, 153, 195, 99, 214, 147, 249, 238, 83, 59, 221, 31, 142, 159, 250, 148, 162, 107, 176 }, "f57d0e07-917a-47ea-86fc-eeee80ae5f13", 0 },
                    { "user7", "user7@example.com", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new byte[] { 161, 97, 213, 112, 231, 203, 8, 179, 77, 29, 250, 210, 157, 178, 128, 197, 176, 72, 60, 74, 165, 189, 8, 140, 218, 25, 93, 37, 235, 96, 165, 142, 255, 230, 70, 98, 66, 118, 154, 209, 103, 97, 173, 42, 149, 131, 181, 203, 220, 253, 196, 165, 133, 148, 39, 137, 104, 120, 93, 130, 78, 221, 14, 143 }, new byte[] { 130, 1, 119, 239, 28, 147, 187, 168, 132, 30, 251, 1, 43, 116, 189, 200, 45, 85, 54, 117, 97, 244, 231, 243, 150, 48, 233, 58, 150, 35, 21, 64, 233, 237, 106, 110, 183, 218, 248, 98, 47, 26, 10, 82, 215, 146, 239, 253, 101, 12, 109, 127, 146, 144, 227, 17, 30, 154, 65, 20, 44, 155, 7, 59, 95, 206, 51, 208, 4, 211, 5, 218, 230, 239, 37, 81, 7, 124, 175, 126, 118, 20, 56, 126, 170, 107, 76, 82, 52, 137, 54, 35, 222, 163, 66, 91, 104, 97, 50, 179, 49, 134, 1, 198, 129, 85, 161, 123, 32, 203, 161, 115, 69, 40, 179, 61, 203, 19, 32, 56, 217, 243, 74, 16, 223, 102, 81, 238 }, "cc7c133a-b731-4299-b310-770ba9f3fe9f", 0 }
                });

            migrationBuilder.InsertData(
                table: "Wifis",
                columns: new[] { "wifi_id", "curr_rate", "download_speed", "max_users", "owned_by", "radius", "security", "time_listed", "upload_speed", "wifi_latitude", "wifi_longitude", "wifi_name", "wifi_source" },
                values: new object[,]
                {
                    { "1c243a97-b08d-4edb-b6e0-2fcadfe26c71", 20.99m, 100, 1, "user3", 10f, "WPA3", new DateTime(2024, 4, 7, 17, 27, 25, 925, DateTimeKind.Local).AddTicks(8258), 50, 100f, -100f, "Wifi_4", "Starlink" },
                    { "1d475c5a-f088-48fc-bb73-e83c5cbd364a", 2.0m, 300, 50, "user1", 10f, "Unsecure", new DateTime(2024, 4, 7, 17, 27, 25, 925, DateTimeKind.Local).AddTicks(8250), 300, 0f, 0f, "Wifi_1", "Fiber" },
                    { "34f3fb03-d917-48d2-8cd9-1e30c085cfb2", 5.0m, 300, 10, "user1", 10f, "More Secure", new DateTime(2024, 4, 7, 17, 27, 25, 925, DateTimeKind.Local).AddTicks(8252), 200, 0f, 0f, "Wifi_2", "Fiber" },
                    { "8f704d7a-7de0-4b03-8230-36cdcc6f21d0", 10.0m, 400, 100, "user10", 10f, "Unsecured", new DateTime(2024, 4, 7, 17, 27, 25, 925, DateTimeKind.Local).AddTicks(8260), 300, 10f, -5f, "Wifi_5", "Starlink" },
                    { "91720bff-b076-4b89-9a6e-36eebd68403f", 0.50m, 500, 1, "user9", 10f, "SurpriseMe", new DateTime(2024, 4, 7, 17, 27, 25, 925, DateTimeKind.Local).AddTicks(8201), 500, 0f, 0f, "ItsWifi", "HotSpot" },
                    { "eca15f8b-ddfe-4109-bc9f-2e053e728c14", 1.0m, 450, 50, "user3", 10f, "WPA2", new DateTime(2024, 4, 7, 17, 27, 25, 925, DateTimeKind.Local).AddTicks(8255), 444, 10f, 10f, "Wifi_3", "ATT Fiber" }
                });
